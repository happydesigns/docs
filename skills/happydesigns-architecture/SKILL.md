...
description: Use when modifying or creating happydesigns projects, packages, Nuxt layers, Nuxt modules, Docus docs, product architecture, or AI agent workflows. Guides agents to preserve product boundaries, layered architecture, brand-neutral cores, and stable documentation practices.
---
...
- Publish unstable task notes as documentation.
