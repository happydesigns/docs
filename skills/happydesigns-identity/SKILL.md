...
identity = reusable identity / brand-layer system
brand = happydesigns-specific brand implementation
```

## Workflow

1. Distinguish the reusable `identity` system from the happydesigns-specific `happydesigns/brand` implementation.
