...
brand = concrete happydesigns brand implementation
```

## Workflow

1. Distinguish the generic `identity` system from the concrete `happydesigns/brand` implementation.
...
- Treat the `brand` repo name as the generic identity product name.
