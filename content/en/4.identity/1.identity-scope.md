...
navigation:
  icon: i-lucide-badge
---
`id` defines reusable identity and brand-layer rules. These docs explain what identity means for the ecosystem, while dedicated `id` docs cover package installation, APIs, examples, and version details.
...
This ecosystem manual defines the cross-product identity boundary:
