...
Define the color system centrally. Components consume semantic tokens.
...
2. Map those palettes to Nuxt UI semantic colors.
3. Override shared `--ui-*` variables centrally.
4. Set component defaults in `app.config.ts`.
5. Use semantic utilities and props in components.
